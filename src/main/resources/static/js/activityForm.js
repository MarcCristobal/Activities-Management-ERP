document.addEventListener("DOMContentLoaded", function () {
  ...
  function addListItem(listId, inputId) {
    ...
    trashIcon.className =
      "size-4 invisible transition duration-300 ease-in-out group-hover:visible"; // Aplica las clases necesarias al ícono de eliminar
  ...
  function updateHiddenField(listId) {
    ...
    document.getElementById(listId + "Hidden").value =
  ...
  function togglePaymentOptions(isFree) {
    var pricePerPersonContainer = document.getElementById(
      "pricePerPersonContainer",
    );
    var numberOfPaymentsContainer = document.getElementById(
